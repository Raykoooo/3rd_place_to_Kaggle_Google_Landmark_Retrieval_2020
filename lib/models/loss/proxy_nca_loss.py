...
class ProxyNCALoss(nn.Module):
    def __init__(self, configer):
        ...
        if 'proxy_nca_loss' in configer.get('loss', 'params'):
            self.params_dict = configer.get('loss', 'params')['proxy_nca_loss']
        self.smoothing_const = self.params_dict['smoothing_const']
